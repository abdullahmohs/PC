...
public class database {
    ...
    private String re, re_par = null, re_open, re_code;
    private String user_name;
    private String pass;
    private String num_user;
    private String kind;
    private String per;
    private int re_pone, re_qun;
    ...
    public String get_price(String parcode) {
        String price = null;
        try {
            connect = (Connection) DriverManager.getConnection(add, user, passwordDB);
            s = connect.prepareStatement("select * from products where parcode like ?");
    ...
    public String getQuntity(String code) {
        String quntity = null;
        try {
            connect = (Connection) DriverManager.getConnection(add, user, passwordDB);
            s = connect.prepareStatement("select * from products where code like ?");
    ...
    public Boolean check_parcode(String parcode) {
        try {
            connect = (Connection) DriverManager.getConnection(add, user, passwordDB);
            s = connect.prepareStatement("select * from products where parcode like ? ");
            s.setString(1, parcode);
    ...
    public String get_code(String parcode) {
        try {
            connect = (Connection) DriverManager.getConnection(add, user, passwordDB);
            s = connect.prepareStatement("select * from products where parcode like ? ");
            s.setString(1, parcode);
    ...
    public void update_details_replace(int num_pone, String total, String cash, String mins, String number, String history) {
        try {
            connect = (Connection) DriverManager.getConnection(add_4, user, passwordDB);
            s = connect.prepareStatement("update pone set total = ? , cash = ? , mins = ? , number = ? , history = ? where num_pone = ?");
            s.setString(1, total);
